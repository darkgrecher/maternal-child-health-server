...
let NotificationsScheduler = NotificationsScheduler_1 = class NotificationsScheduler {
        ...
        try {
            ...
            for (const appointment of appointments) {
                try {
                    ...
                    const userActor = {
                        id: child.userId,
                        actorType: client_1.RecipientActorType.user,
                    };
                    const userRecipient = await this.notificationsService.createInAppNotificationForActor(userActor, {
                    ...
                    if (child.midwifeId) {
                        const midwifeActor = {
                            id: child.midwifeId,
                            actorType: client_1.RecipientActorType.midwife,
                        };
                        const midwifeRecipient = await this.notificationsService.createInAppNotificationForActor(midwifeActor, {
                            type: client_1.NotificationType.appointment,
        ...
        try {
            ...
            for (const record of records) {
                try {
                    ...
                    const userRecipient = await this.notificationsService.createInAppNotificationForActor(userActor, {
                        type: client_1.NotificationType.vaccination,
        ...
        try {
            ...
            for (const midwife of midwives) {
                try {
                    ...
                    const recipient = await this.notificationsService.createInAppNotificationForActor(midwifeActor, {
                        type: client_1.NotificationType.daily_digest,
                        title: 'Daily digest',
                        message,
                        data: {
    ...
    async logRun(event, message, metadata, level = client_1.LogLevel.info) {
...
], NotificationsScheduler.prototype, "handleAppointmentReminders", null);
__decorate([
    (0, schedule_1.Cron)('0 7 * * *'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], NotificationsScheduler.prototype, "handleVaccinationReminders", null);
__decorate([
    (0, schedule_1.Cron)('0 18 * * *'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], NotificationsScheduler.prototype, "handleDailyDigest", null);
