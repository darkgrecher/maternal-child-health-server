...
import { LogActorType, LogLevel, Prisma, PrismaClient } from '@prisma/client';
...
async function main() {
  ...
  const logEntries: Array<{ id: string; data: Prisma.SystemLogCreateInput }> = [
    {
    ...
    },
    {
      ...
      data: {
        ...
        actorType: LogActorType.midwife,
        actorId: midwife.id,
        createdAt: baseDate,
